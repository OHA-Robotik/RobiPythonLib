...
class I2C_HAL(HD44780_Controller):
...
class HD44780_I2C_driver(base_driver.I2C_BaseDriver, I2C_HAL):
    ...
    def __init__(self, i2c_interface: object, i2c_addr: int) -> None:
        ...
        driver_prefs = platform_description.PlatformLoader.get_instance().get_preference_for_driver('hd44780_i2c')
        I2C_HAL.__init__(
            self,
            self.i2c_interface,
            self.i2c_addr,
            driver_prefs['num_lines'],
            driver_prefs['num_columns'],
        )
